# Contribute to GTPlanner

**Language**: [English](contribute.md) | [简体中文](docs/zh/CONTRIBUTING.md) | [日本語](docs/ja/CONTRIBUTING.md)

---

**Translation to English in progress...**

Please refer to the [Chinese version](docs/zh/CONTRIBUTING.md) for now.
